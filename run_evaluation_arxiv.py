...
def evaluate(data_dir: pathlib.Path, results_dir: pathlib.Path, plot_dir: pathlib.Path) -> None:
    ...
    # Figure 1a: Test-set prediction performance by feature-set size "k" and feature-selection
    # method
    ...
    # Figure 1b: Difference in feature-set quality between feature-set sizes "k" by evaluation
    ...
    for metric in plot_metrics:
        ...
        # Figures 2a-2c: Standard deviation of feature-set quality in search runs by search
    ...
    for metric, ylim, min_tick in zip(
        ...
        # Figures 3a-3c: Average feature-set quality in search runs by search method and number
    ...
    for search_method_pair, search_method_file_infix in search_methods:
        ...
        for parameter, parameter_label, parameter_file_infix in parameters:
            ...
            # Figures 4a-4d: Difference in feature-set quality between exact and heuristic
    ...
    print('\n## Table 3: Optimization status by feature-selection method and search method (for',
    ...
    print('\n## Table 4: Optimization status by number of alternatives (for simultaneous search',
    ...
    print('\n## Table 5: Mean optimization time by feature-selection method and search method',
    ...
    print('\n## Table 6: Mean optimization time by number of alternatives and feature-selection',
    ...
    for fillna in (False, True):
        ...
        for metric in plot_metrics:
            ...
            # Figures 5a-5f (Model Gain) and 7a-7d (other feature-selection methods):
    ...
    for k in results['k'].unique():
        ...
        # Figures 6a, 6b: Optimization status (fraction optimal = not infeasible) by number of
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Creates the paper\'s plots and prints statistics.',
