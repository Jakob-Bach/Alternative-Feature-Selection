...
In this experimental file, "mip" is used for optimization (default before switching to OR-Tools).
To use this file, checkout b032860a86 (newer versions might work as well) and replace "afs.py".
"""
